...
public class Person {
	...
	/**
	 * returns the person's full name: concatenation of their first and last name
	 * separated by a space, e.g. Robert Smith
	 **/
	 ...
	 * strings. If the new first name or the the new last name is an empty string ""
	 * then the corresponding name is not changed
	 **/
